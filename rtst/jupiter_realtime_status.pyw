...
__date__ = "$DateTime: 2020/11/19 09:03:23 $"
...
Hotkeys:
 ...
 TRACKPAD
  ...
  I\tToggle trackpad IIR filtering
  ...
  A\tDisplay trackpad calibration (both sensors)
...
# Debug
		...
		ui_root.debug_mode += 1
		if ui_root.debug_mode > 2:
			ui_root.debug_mode = 0
		cntrlr_mgr.trackpad_set_debug_mode(ui_root.debug_mode)
...
# Haptic
		...
		if ui_root.trackpad_framerate < 4:
			ui_root.trackpad_framerate = 4
...
# Thumbstick Command
		...
		cntrlr_mgr.set_thumbstick_raw(ui_root.thumbstick_raw_mode)
...
# Toggle trackpad IIR
		...
		ui_root.trackpad_iir = not ui_root.trackpad_iir
		cntrlr_mgr.set_setting(65, ui_root.trackpad_iir)
...
#		cntrlr_mgr.trackpad_set_debug_mode(0xA)
...
ui_root = UIRoot(cntrlr_mgr, root, canvas, color_pallete)
